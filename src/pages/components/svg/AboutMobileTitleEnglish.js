...
function AboutMobileTitleEnglish(props) {
  return (
    <svg
    ...
    >
      ...
      <g transform="translate(.002 .003)" filter="url(#prefix__a)">
        <path
      ...
      <text
        data-name="ABOUT US"
        transform="rotate(-3 643.008 -1085.934)"
        fill="#fff"
        fontSize={18}
...
export default AboutMobileTitleEnglish;
