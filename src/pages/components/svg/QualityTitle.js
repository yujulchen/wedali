...
function QualityTitle(props) {
  return (
    ...
    >
      ...
      <g transform="translate(0 -.003)" filter="url(#quality_a)">
        <path
      ...
      <text
        transform="rotate(3 -1364.082 12097.424)"
        fill="#fff"
        fontSize={20}
      ...
      <g>
        <g transform="translate(-.004 .005)" filter="url(#quality_b)">
          <path
