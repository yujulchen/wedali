...
function ProductTitle(props) {
  return (
    ...
    >
      ...
      <g transform="translate(0 -.003)" filter="url(#product_a)">
        <path
      ...
      <text
        transform="rotate(3 -1390.93 11795.418)"
        fill="#fff"
        fontSize={24}
      ...
      <g>
        <g transform="translate(-.004 .005)" filter="url(#product_b)">
          <path
        ...
        <text
          transform="rotate(-3 1522.444 -4153.538)"
          fill="#fff"
          fontSize={24}
          fontFamily="NotoSansTC-Regular, Noto Sans TC"
        >
