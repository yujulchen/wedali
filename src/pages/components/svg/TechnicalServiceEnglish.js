...
function TechnicalServiceEnglish(props) {
  return (
    <svg
    ...
    >
      ...
      <g data-name="Group 219">
        <g filter="url(#TechnicalServiceEnglish_a)">
        ...
        <g data-name="Group 186">
          <g data-name="Group 218" fill="#fff">
            ...
            <text
              data-name="Providing ODM/OEM product advise."
...
export default TechnicalServiceEnglish;
